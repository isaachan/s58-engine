...
const en: Dict = {
  ...
  'topbar.changeEngine': 'Change engine',

  // landing
  'landing.title': 'Choose an engine',
  'landing.choose': 'Training module',
  'landing.lastUsed': 'Last used',
  'landing.progress': 'Progress',
  'landing.notStarted': 'Not started',
  'landing.layout': 'Layout',
  'landing.displacement': 'Displacement',
  'landing.cylinders': 'Cylinders',
  'landing.turbo': 'Turbo',
  'landing.output': 'Output',
  'landing.redline': 'Redline',
  'landing.cr': 'Compression',
  'landing.firing': 'Firing order',
...
const zh: Dict = {
  ...
  'lang.title': '切换语言',
  'topbar.changeEngine': '更换发动机',

  'landing.title': '选择发动机',
  'landing.choose': '培训模块',
  'landing.lastUsed': '上次使用',
  'landing.progress': '进度',
  'landing.notStarted': '未开始',
  'landing.layout': '布局',
  'landing.displacement': '排量',
  'landing.cylinders': '气缸数',
  'landing.turbo': '涡轮',
  'landing.output': '输出',
  'landing.redline': '红线转速',
  'landing.cr': '压缩比',
  'landing.firing': '点火顺序',
